  ...
  return (
    <>
      ...
      <header className='flex justify-between items-center h-32 w-full text-center bg-[#0072BD] text-white p-4 bg-opacity-70'>
        <div>
          <NavLink to="/form" className="text-black hover:text-red-700 w-full text-nowrap text-3xl bg-none" >Trang Chủ</NavLink>
        </div>
        ...
        <nav className="flex justify-center items-center   m-96 bg-[#0072BD] text-white p-4">
          <ul className="flex items-center space-x-6 list-none m-0 p-0">
            <li >
              <NavLink to="/phongview" className="text-black hover:text-blue-400 rounded-sm text-nowrap">
                Phòng View Model
              </NavLink>
            </li>
            <li>
              <NavLink to="/capnhatnguoidung" className="text-black hover:text-blue-800 text-nowrap">
                Cập Nhật Người Dùng
              </NavLink>
            </li>
            <li>
              <NavLink to="/binhluan" className="text-black hover:text-blue-800 text-nowrap">
                Bình Luận
              </NavLink>
            </li>
            <li>
              <NavLink to="/datphong" className="text-black hover:text-blue-800 text-nowrap">
                Đặt Phòng
              </NavLink>
            </li>
            <li>
              <NavLink to="/thongtinnguoidung" className="text-black hover:text-blue-800 text-nowrap">
                Thông Tin Người Dùng
              </NavLink>
            </li>
            <li>
              <NavLink to="/vitri" className="text-black hover:text-blue-800 text-nowrap">
                Vị Trí
              </NavLink>
            </li>
            <li >
              <NavLink to="/dangnhap" className="text-black hover:text-blue-800 text-nowrap">
                Đăng Nhập
              </NavLink>
            </li>
            <li>
              <NavLink to="/taotaikhoan" className="text-black hover:text-blue-800 text-nowrap">
                Tạo Tài Khoản
              </NavLink>
            </li>
          </ul>
